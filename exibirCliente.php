<?php 
    ...
    $sqlExibir = "SELECT * FROM clientela";
    $limites = mysqli_query($conec, $sqlExibir);
...
<body>
    ...
    <div class="jumbotron gradient">
        <h1 class="titles mt-5">Exibição de Clientes Cadastrados</h1>
    </div>
        ...
        <div class="col-7 col-sm-7 col-md-7  bg-backform">
            <div class="row mt-5 ml-3 mr-3">
                <div class="col-12 col-sm-12 col-md-12 ">
                    <h4 class="bg-texttitle text-center mt-4">Clientes Salvos</h4> <br>
                    
                    <?php

                        while($sqlExibir = mysqli_fetch_array($limites)){
                            $nomeCliente = $sqlExibir["nomeCliente"];
                            $alternativaCliente = $sqlExibir["alternativaCliente"];
                            $cpfCliente = $sqlExibir["cpfCliente"];
                            $ruaCliente = $sqlExibir["ruaCliente"];
                            $numeroCliente = $sqlExibir["numeroCliente"];
                            $bairroCliente = $sqlExibir["bairroCliente"];
                            $cepCliente = $sqlExibir["cepCliente"];
                            $cidadeCliente = $sqlExibir["cidadeCliente"];
                            $estadoCliente = $sqlExibir["estadoCliente"];
                            $telefoneCliente = $sqlExibir["telefoneCliente"];
                            $emailCliente = $sqlExibir["emailCliente"];
                            
                            echo "NOME: $nomeCliente <br/> SEXO: $alternativaCliente <br/> CPF: $cpfCliente <br/> RUA: $ruaCliente <br/> NÚMERO DA CASA: $numeroCliente <br/> BAIRRO: $bairroCliente <br/> CEP: $cepCliente <br/> CIDADE: $cidadeCliente <br/> ESTADO: $estadoCliente <br/> TELEFONE: $telefoneCliente <br/> E-MAIL: $emailCliente <br/>";
