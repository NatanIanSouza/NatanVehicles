<?php 
    ...
    $sqlExibindo = "SELECT * FROM funcionarios";
    $limitando = mysqli_query($conect, $sqlExibindo);
...
<body>
    ...
    <div class="jumbotron gradient">
        <h1 class="titles mt-5">Exibição de Funcionários Cadastrados</h1>
    </div>
        ...
        <div class="col-7 col-sm-7 col-md-7  bg-backform">
            <div class="row mt-5 ml-3 mr-3">
                <div class="col-12 col-sm-12 col-md-12 ">
                    <h4 class="bg-texttitle text-center mt-4">Funcionário Cadastrado</h4> <br>
                    
                    <?php

                        while($sqlExibindo = mysqli_fetch_array($limitando)){
                            $chapa = $sqlExibindo["chapa"];
                            $nomeFunc = $sqlExibindo["nomeFunc"];
                            $alternativaFunc = $sqlExibindo["alternativaFunc"];
                            $cpfFunc = $sqlExibindo["cpfFunc"];
                            $ruaFunc = $sqlExibindo["ruaFunc"];
                            $numeroFunc = $sqlExibindo["numeroFunc"];
                            $bairroFunc = $sqlExibindo["bairroFunc"];
                            $cepFunc = $sqlExibindo["cepFunc"];
                            $cidadeFunc = $sqlExibindo["cidadeFunc"];
                            $estadoFunc = $sqlExibindo["estadoFunc"];
                            $telefoneFunc = $sqlExibindo["telefoneFunc"];
                            $emailFunc = $sqlExibindo["emailFunc"];

                            echo "CHAPA: $chapa <br/> NOME: $nomeFunc <br/> SEXO: $alternativaFunc <br/> CPF: $cpfFunc <br/> RUA: $ruaFunc <br/> NÚMERO DA CASA: $numeroFunc <br/> BAIRRO: $bairroFunc <br/> CEP: $cepFunc <br/> CIDADE: $cidadeFunc <br/> ESTADO: $estadoFunc <br/> TELEFONE: $telefoneFunc <br/> E-MAIL: $emailFunc <br/>";
